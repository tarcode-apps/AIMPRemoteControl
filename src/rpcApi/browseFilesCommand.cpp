...
void rpcapi::BrowseFilesCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("BrowseFiles", [core = FCore, &settings = FSettings](const nlohmann::json &params) -> nlohmann::json
			{
