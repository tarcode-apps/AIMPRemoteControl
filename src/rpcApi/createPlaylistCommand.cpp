...
void rpcapi::CreatePlaylistCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("CreatePlaylist", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
