...
void rpcapi::EnqueueTrackCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("EnqueueTrack", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
