...
#include "helpers/equalizerBands.h"
#include "mainThreadRunner.h"

void rpcapi::EqualizerCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("Equalizer", [core = FCore](const nlohmann::json &params) -> nlohmann::json
			{
