...
void rpcapi::LyricsCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("Lyrics", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
