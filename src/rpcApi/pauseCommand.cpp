...
void rpcapi::PauseCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("Pause", [core = FCore, &idManager = FIdManager](const nlohmann::json &) -> nlohmann::json
