...
void rpcapi::PlayCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("Play", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
