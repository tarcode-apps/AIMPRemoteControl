...
void rpcapi::PlayNextCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("PlayNext", [core = FCore, &idManager = FIdManager, &events = FEvents](const nlohmann::json &) -> nlohmann::json
	{
