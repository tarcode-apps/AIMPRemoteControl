...
void rpcapi::PlayPreviousCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("PlayPrevious", [core = FCore, &idManager = FIdManager, &events = FEvents](const nlohmann::json &) -> nlohmann::json
			{
