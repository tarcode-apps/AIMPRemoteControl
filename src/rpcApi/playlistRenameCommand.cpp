...
void rpcapi::PlaylistRenameCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("PlaylistRename", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
