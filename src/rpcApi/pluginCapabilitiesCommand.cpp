...
void rpcapi::PluginCapabilitiesCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("PluginCapabilities", [&settings = FSettings](const nlohmann::json &) -> nlohmann::json
	{
