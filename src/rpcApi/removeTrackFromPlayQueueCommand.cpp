...
void rpcapi::RemoveTrackFromPlayQueueCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("RemoveTrackFromPlayQueue", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
