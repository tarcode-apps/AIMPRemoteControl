...
void rpcapi::SetTrackEnabledCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("SetTrackEnabled", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
