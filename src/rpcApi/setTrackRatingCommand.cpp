...
void rpcapi::SetTrackRatingCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("SetTrackRating", [core = FCore, &idManager = FIdManager](const nlohmann::json &params) -> nlohmann::json
			{
