...
void rpcapi::ShowMessageCommand::Register(IEndpointRouteBuilder &endpoints)
{
	endpoints.MapRpc("ShowMessage", [core = FCore](const nlohmann::json &params) -> nlohmann::json
	{
